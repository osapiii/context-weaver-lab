...
TASK_INVOKE_HANDLERS: dict[str, dict[str, Any]] = {
    ...
    "storyvault": {"merge": _noop_merge, "validate": _noop_validate},
    "storyvault_related_context": {"merge": _noop_merge, "validate": _noop_validate},
    "storyvault_zapping_analysis": {"merge": _noop_merge, "validate": _noop_validate},
    "storyvault_capability_structuring": {"merge": _noop_merge, "validate": _noop_validate},
    "storyvault_story_generation": {"merge": _noop_merge, "validate": _noop_validate},
