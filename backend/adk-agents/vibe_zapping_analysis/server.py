"""Cloud Run entrypoint for VibeControl Zapping Analysis agent."""
...
from vibe_zapping_analysis.agent import root_agent  # type: ignore  # noqa: E402

app = create_app(
    mode="vibe_zapping_analysis",
    app_name="vibe-zapping-analysis-agent",
