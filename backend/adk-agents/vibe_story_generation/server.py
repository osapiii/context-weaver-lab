"""Cloud Run entrypoint for VibeControl Story Generation agent."""
...
from vibe_story_generation.agent import root_agent  # type: ignore  # noqa: E402

app = create_app(
    mode="vibe_story_generation",
    app_name="vibe-story-generation-agent",
