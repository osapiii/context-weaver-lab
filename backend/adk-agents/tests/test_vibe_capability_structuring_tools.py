"""Tests for VibeControl capability structuring tools."""
from __future__ import annotations

from vibe_capability_structuring.tools import (
...
def test_build_capability_structure_package_normalizes_capabilities_and_patches():
    package = build_capability_structure_package(
        application={
            ...
            "repo_full_name": "enostech/vibe-control",
        },
...
def test_save_capability_structure_returns_json_artifact():
    ...
    assert result["vibe_capability_structuring"]["capability_count"] == 1
