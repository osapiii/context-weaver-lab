"""Tests for StoryVault SSOT package tools."""
from __future__ import annotations

from storyvault.tools import build_story_ssot_package, save_user_story_ssot
...
def test_save_user_story_ssot_returns_json_document_artifact():
    ...
    assert result["storyvault"]["application_count"] == 1
    assert result["storyvault"]["story_count"] == 1
        ...
        stories=[
            {
                ...
                "applicationKey": "VC",
                "applicationName": "StoryVault Platform",
                "storyKey": "ST-201",
