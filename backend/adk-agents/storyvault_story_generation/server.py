"""Cloud Run entrypoint for StoryVault Story Generation agent."""
...
from storyvault_story_generation.agent import root_agent  # type: ignore  # noqa: E402

app = create_app(
    mode="storyvault_story_generation",
    app_name="storyvault-story-generation-agent",
