"""Cloud Run entrypoint for StoryVault Capability Structuring agent."""
...
from storyvault_capability_structuring.agent import root_agent  # type: ignore  # noqa: E402

app = create_app(
    mode="storyvault_capability_structuring",
    app_name="storyvault-capability-structuring-agent",
