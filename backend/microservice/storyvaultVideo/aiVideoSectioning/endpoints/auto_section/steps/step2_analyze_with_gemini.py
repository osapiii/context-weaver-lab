...
GEMINI_MODEL = (
    os.environ.get("STORYVAULT_VIDEO_SECTIONING_GEMINI_MODEL")
    or os.environ.get("VOHANCE_VIDEO_SECTIONING_GEMINI_MODEL")
...
def _get_genai_client() -> Optional[genai.Client]:
    ...
    try:
        ...
        if api_key:
            ...
            project_id = context.google_cloud_project or "storyvault-dev"
            location = (
                os.environ.get("STORYVAULT_VIDEO_SECTIONING_GEMINI_LOCATION")
                or os.environ.get("VOHANCE_VIDEO_SECTIONING_GEMINI_LOCATION")
                or "global"
            )
