...
```json
{
  ...
  "input": {
    "mode": "audioFile",
    "sourceFileBucketName": "storyvault-sandbox",
    "sourceFilePath": "audio/sample.flac",
    "outputBucketName": "storyvault-transcripts",
...
{
  "success": true,
  "transcription_path": "gs://storyvault-transcripts/output/result.json",
...
| `STORYVAULT_VIDEO_TRANSCRIBE_GEMINI_MODEL` | gemini-2.5-flash-lite | 段落整形用Vertex AI Geminiモデル |
| `STORYVAULT_VIDEO_TRANSCRIBE_GEMINI_LOCATION` | global | 段落整形用Vertex AIロケーション |
| `PORT` | 8080 | サービスポート |
...
Proprietary - StoryVault Development Team
