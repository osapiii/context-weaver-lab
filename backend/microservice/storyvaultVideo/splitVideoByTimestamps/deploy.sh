...
# 設定
SERVICE_NAME="${SERVICE_NAME:-storyvault-split-video-by-timestamps}"
...
log_info "Split video endpoint: $SERVICE_URL/split"
log_info ""
log_info "Example request:"
log_info 'curl -X POST '$SERVICE_URL'/split \'
log_info '  -H "Content-Type: application/json" \'
log_info '  -d "{"videoFilePath":"video.mp4","bucketName":"your-bucket","cutoffSeconds":[10,30,60],"outputVideoFileParentPath":"output/"}"'
