...
curl -X POST https://your-service-url/merge-audio \
  ...
  -d '{
    "audio_files": [
      "gs://storyvault-sample-videos/audio1.mp3",
      "gs://storyvault-sample-videos/audio2.wav"
    ],
    "buffer_seconds": 2.0,
    "output_gcs_filepath": "gs://storyvault-sample-videos/merged_output.mp3"
  }'
```
...
このプロジェクトはStoryVaultプロジェクトの一部です。
