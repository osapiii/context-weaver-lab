...
export const REQUEST_LOG_REGISTRY = [
  ...
  {
    type: "autoSectionVideoRequest",
    label: "動画 自動セクション分割",
    collectionPath: "requests/autoSectionVideoRequests/logs",
    scope: "space",
    color: "#a855f7",
  },
  {
    type: "splitVideoRequest",
    label: "動画 分割",
    collectionPath: "requests/splitVideoRequests/logs",
    scope: "space",
    color: "#6366f1",
  },
  {
    type: "videoTranscriptionRequest",
    label: "動画 文字起こし",
    collectionPath: "requests/videoTranscriptionRequests/logs",
    scope: "space",
    color: "#0ea5e9",
  },
  {
    ...
    label: "動画 TTS",
    collectionPath: "requests/textToSpeechRequests/logs",
    scope: "space",
    color: "#10b981",
  },
  {
    type: "mergeVideoAudioNarrationRequest",
    label: "動画 音声合成",
    collectionPath: "requests/mergeVideoAudioNarrationRequests/logs",
    scope: "space",
    color: "#f97316",
  },
  {
    type: "concatenateSectionVideosRequest",
    label: "動画 セクション連結",
    collectionPath: "requests/concatenateSectionVideosRequests/logs",
    scope: "space",
    color: "#f59e0b",
  },
  {
    type: "addVideoSubtitleRequest",
    label: "動画 字幕追加",
    collectionPath: "requests/addVideoSubtitleRequests/logs",
    scope: "space",
    color: "#ec4899",
  },
  {
    type: "trimSilenceVideoRequest",
    label: "動画 無音カット",
    collectionPath: "requests/trimSilenceVideoRequests/logs",
    scope: "space",
    color: "#64748b",
  },
  {
