...
const props = defineProps<{
  ...
  generationSessions: DecodedStoryVaultGenerationSession[];
  isGenerating: boolean;
}>();

const emit = defineEmits<{
  "structure-capabilities": [input: StoryVaultGenerationInput];
}>();
...
const baseInput = (): StoryVaultGenerationInput | null => {
